...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    content: "Generate anonymous personas using SHA-256 hashing. Your identity is cryptographically protected.",
    placement: "right",
  },
  {
    id: "stealth-vault",
    ...
    title: "Stealth Vault",
    content: "Upload encrypted evidence and submit grievances. All files are securely stored.",
    placement: "right",
  },
  {
    id: "arena",
    ...
    title: "The Arena",
    content: "Watch AI agents negotiate resolutions in real-time using the Multi-Agent Negotiation Matrix.",
    placement: "right",
  },
  {
    id: "ledger",
  ...
  },
  {
    ...
    content: "Toggle Demo Mode for sample data, enable sound effects, and access advanced features like Dead Man's Switch.",
    placement: "right",
  },
];
